...
from app.services.warehouse_scope import location_ids_for_warehouse_scope
...
def _fefo_available_for_product(
    db: Session,
    product_id: UUID,
    ...
    *,
    ...
    if location_ids is not None:
        query = query.filter(LocationModel.id.in_(location_ids))
