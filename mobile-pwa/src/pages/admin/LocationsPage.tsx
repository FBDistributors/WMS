          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="relative">
              <input
                ...
                className="max-w-56 rounded-2xl border border-slate-200 bg-white py-2 pl-3 pr-9 text-sm text-slate-900 placeholder:text-slate-400 outline-none focus:ring-2 focus:ring-blue-500 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
              />
              {filterQuery && (
                <button
                  type="button"
